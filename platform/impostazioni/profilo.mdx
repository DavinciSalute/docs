...
- Se utilizzi un account Medico si deve **completare il profilo** con i seguenti dati:
  ...
  - **Codice regionale.**
  - **Partita IVA (P.IVA):** necessaria per utilizzare la funzionalità di fatturazione elettronica. La P.IVA è visibile e modificabile direttamente dalla sezione "Le tue informazioni" del profilo; se non ancora inserita, verrà mostrato "Non inserita".
...
- Nella sezione **"Timbro ricette e certificati"** si può visualizzare il proprio timbro, che include **intestazione** e **piè di pagina** personalizzabili. Per disattivarlo bisogna cliccare il tasto in alto a destra.
- Il timbro viene applicato automaticamente su **ricette** (rosse e bianche) e **certificati** in formato PDF. La formattazione (posizione, dimensione del testo) si adatta in base al tipo di documento.
