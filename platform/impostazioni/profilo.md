...
<Warning>
  N.B.: Il numero di telefono che compare sulle ricette viene recuperato dalle informazioni inserite durante la registrazione. La modifica è a cura del nostro team (non si può modificare direttamente dal profilo). Consiglio l'inserimento del numero di ambulatorio così che i pazienti non vi contattino direttamente sul numero personale.
</Warning>