...
- La sezione Ricette in scheda paziente permette di creare ed elaborare le prescrizioni
    ...
    ![Screenshot 2025-04-16 alle 11.22.38.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.22.38.png)
...
- Per prescrivere un farmaco, seleziona "Farmaco".
    ...
    ![Screenshot 2025-04-16 alle 11.22.52.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.22.52.png)
...
- Clicca "passa a posologia libera" per inserire una posologia testuale (questa posologia non permetterà però il calcolo delle scorte)
    ...
    ![Screenshot 2025-04-16 alle 11.24.09.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.24.09.png)
    
    ![Screenshot 2025-04-16 alle 11.43.21.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.43.21.png)
    
    ![Screenshot 2025-04-16 alle 11.43.29.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.43.29.png)
...
- Aggiungi l'esenzione e note in ricetta (a volte obbligatorie sulla base delle regole prescrittive del farmaco).
    ...
    ![Screenshot 2025-04-16 alle 11.24.21.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.24.21.png)
...
- Con l'elaborazione ci sarà la validazione del sistema regionale e la ricetta arriverà via FSE, Email (se impostata l'opzione in Gestione servizi e se inserita all'interno della scheda anagrafica del paziente), via App (se scaricata dal paziente) e via SMS con codice NRE (in alcune regioni)
    ...
    ![Screenshot 2025-04-04 alle 14.14.58.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-04_alle_14.14.58.png)
...
- Per prescrivere una prestazione, seleziona ***"Prestazione"***.
    ...
    ![Screenshot 2025-04-16 alle 11.22.52 2.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.22.52_2.png)
...
- Si aprirà una schermata, di default sarai su "Aggiungi prestazione singola". Cerca la prestazione che vuoi prescrivere all'interno del box di ricerca.
    ...
    ![Screenshot 2025-04-16 alle 11.24.29.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.24.29.png)
...
- Apparirà un'anteprima della visita, clicca su ***"Conferma"*** per salvarla.
    ...
    ![Screenshot 2025-04-16 alle 11.48.28.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.48.28.png)
...
- Scrivere il **quesito diagnostico (p**uoi passare a **"Quesito codificato").**
    ...
    ![Screenshot 2025-04-16 alle 11.48.42.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.48.42.png)
    
- Nel quesito codificato devi inserire lo **stato** e **nota quesito**.
    
    ![Screenshot 2025-04-16 alle 11.48.58.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.48.58.png)
...
- Risolto
    ...
    ![Screenshot 2025-04-16 alle 11.56.29.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.56.29.png)
    
- Continuando, bisogna inserire la **classe priorità** e spuntare la casella se è una **visita domiciliare**
    
    ![Screenshot 2025-04-16 alle 11.51.32.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.51.32.png)
...
- P - Programmata
    ...
    ![Screenshot 2025-04-16 alle 11.52.23.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.52.23.png)
...
- Suggerito da uno specialista
    ...
    ![Screenshot 2025-04-16 alle 11.49.11.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.49.11.png)
...
- Per prescrivere un trasporto sanitario, seleziona ***"Trasporto Sanitario"***.
    ...
    ![Screenshot 2025-04-16 alle 11.22.52 3.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.22.52_3.png)
...
- Ripetibilità di trasporto (da 1 a 5)
    ...
    ![Screenshot 2025-04-16 alle 12.28.33.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_12.28.33.png)
...
- Altro indirizzo
    ...
    ![Screenshot 2025-04-16 alle 12.28.42.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_12.28.42.png)
    
- inserisci l'indirizzo completo per partenza e arrivo.
    
    ![Screenshot 2025-04-16 alle 12.34.01.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_12.34.01.png)
    
- La prescrizione sarà in bozza pronta per essere elaborata.
    
    ![Screenshot 2025-04-16 alle 12.34.12.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_12.34.12.png)
...
- Per prescrivere un ricovero ospedaliero, seleziona ***"Ricovero ospedaliero"***.
    ...
    ![Screenshot 2025-04-16 alle 11.22.52 4.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.22.52_4.png)
...
![Screenshot 2025-04-16 alle 11.25.06.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.25.06.png)

### 6. Prescrizione libera

- Seleziona ***"Prescrizione libera" per fare una prescrizione libera "Bianca cartacea" o "Rossa cartacea"***.
    
    ![Screenshot 2025-04-16 alle 11.22.52 5.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-16_alle_11.22.52_5.png)
    
- Scrivi la prescrizione a mano libera nel campo testuale. Per salvare clicca su ***"Prescrivi"***.
    
    ![Screenshot 2025-04-18 alle 09.17.11.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-18_alle_09.17.11.png)
...
- Se suggerita
    ...
    ![Screenshot 2025-04-18 alle 09.17.26.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-18_alle_09.17.26.png)
...
- Si può **rimandare l'elaborazione della ricetta** a un momento successivo cliccando "***Elabora più tardi***".
    ...
    ![Screenshot 2025-04-04 alle 14.14.58.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-04_alle_14.14.58%201.png)
    
- La ricetta verrà automaticamente spostata nella sezione **"*Ricette*" → "*Da elaborare*".**
Per completare l'operazione, clicca ***"Elabora tutte" in alto a destra*.**
    
    ![Screenshot 2025-04-23 alle 10.48.04.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-23_alle_10.48.04.png)
    
- Cliccando ***"Elabora" all'interno della bozza di ricetta (in basso a destra)*** la ricetta viene validata dal sistema regionale.
    
    ![Screenshot 2025-04-04 alle 14.14.58 2.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-04_alle_14.14.58_2.png)
    
- Per vedere lo storico delle ricette elaborate relative al paziente clicca su "***Vai all'archivio***".
    
    ![Screenshot 2025-04-23 alle 10.50.45.png](/images/platform/ricette-scheda-paziente/Screenshot_2025-04-23_alle_10.50.45.png)
