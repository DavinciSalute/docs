...
<Note>
Per le **ricette rosse DEM** nelle regioni che utilizzano il sistema SOGEI, durante l'elaborazione viene richiesta un'autenticazione a due fattori (2FA): il medico riceve un codice OTP e deve inserirlo per completare la trasmissione della ricetta.
</Note>
