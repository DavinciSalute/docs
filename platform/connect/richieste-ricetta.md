...
- Si può accede alle **richieste** di ricetta cliccando “***Richieste***” in alto o “***Richieste di ricetta***” dalla **home**
    ...
    ![1..png](/images/platform/richieste-ricetta/1..png)
    
- La schermata visualizzata è composta da:
    - Richieste “Da prescrivere”
    - Richieste “Da rinnovare”
    - Archivio
    
    ![2..png](/images/platform/richieste-ricetta/2..png)
    
- Per inserire manualmente una richiesta di ricetta bisogna cliccare “***Nuova richiesta***” in alto a destra (sezione “Richieste”).
    
    ![3..png](/images/platform/richieste-ricetta/3..png)
    
- Si inserisce il nome del “***Paziente***” e la tipologia di ricetta richiesta: “***Farmaco***” o “Prestazione”.
    
    ![4..png](/images/platform/richieste-ricetta/4..png)
...
- Quando si inserisce il nome del paziente comparirà una preview con le sue informazioni anagrafiche. Si seleziona “Farmaco” e “***Conferma***” per continuare.
    ...
    ![5..png](/images/platform/richieste-ricetta/5..png)
...
- Nel caso di una richiesta di “***Farmaco***” ci saranno due sezioni: “***Rinnova farmaco***” e “***Nuovo farmaco***”.
    ...
    ![6..png](/images/platform/richieste-ricetta/6..png)
...
- Sia per “Rinnova farmaco” che per “Nuovo farmaco” si possono inserire delle “***Note interne***”
    ...
    ![7..png](/images/platform/richieste-ricetta/7..png)
...
- Dopo aver confermato, la richiesta comparirà nella sezione “***Richieste***” → “***Da prescrivere***” (se il farmaco / prestazione non è mai stato prescritto in Elty) oppure in “Richieste” → “Da rinnovare” (se già prescritto in passato)
    ...
    ![8..png](/images/platform/richieste-ricetta/8..png)
    
- Cliccando i **tre puntini** a destra della richiesta, comparirà un menù a tendina con numerose funzioni:
- **Elimina** (per eliminare la “Richiesta”)
- **Modifica nota interna** (per modificare la nota interna precedentemente scritta)
- **Invia nota al paziente** (per inviare una nota in App al paziente, che comparirà nelle notifiche del paziente)
    
    ![10..png](/images/platform/richieste-ricetta/10..png)
    
- Nel caso in cui si ***invia una nota al paziente*** si potranno anche allegare dei file.
    
    ![Screenshot 2025-04-04 alle 14.07.02.png](/images/platform/richieste-ricetta/Screenshot_2025-04-04_alle_14.07.02.png)
...
![image.png](/images/platform/richieste-ricetta/image.png)
...
- Per prescrivere la richiesta tramite Elty (funziona solo nelle regioni in cui Elty è anche gestionale permettendo l’elaborazione delle ricette) bisogna cliccare su “***Prescrivi***”.
    ...
    ![Screenshot 2025-04-04 alle 14.13.41.png](/images/platform/richieste-ricetta/Screenshot_2025-04-04_alle_14.13.41.png)
...
- Compariranno i “***Dettagli richiesta***”. Con il nome del “***Farmaco***”. Si possono cliccare “*Prescrivi solo per principio attivo*”, “*Non sostituibile*” e “*Continuativo*”. Si può selezionare anche la sezione “***Farmaci equivalenti in commercio***” per poter visualizzare i farmaci equivalenti.
    ...
    ![14..png](/images/platform/richieste-ricetta/14..png)
...
- Nella sezione “***Confezioni e posologia***” si possono inserire il numero di confezioni, le unità, i giorni, la durata, la via di somministrazione e la modalità di assunzione (per avere una posologia strutturata e poter calcolare le scorte del paziente, si può convertire la posologia in una posologia libera cliccando il tasto “Passa a posologia libera”, da lì si potrà inserire un testo perdendo però la possibilità di calcolare le scorte). Si possono selezionare le esenzioni del paziente nella sezione “***Esenzione***” e si possono scrivere note nella sezione “***Note in ricetta***”
    ...
    ![15..png](/images/platform/richieste-ricetta/15..png)
...
- Dopo aver cliccato “***Prescrivi***” sarai portato alla ***scheda del paziente, sezione “Ricette”***, all’interno di questa pagina, sotto la sezione “Crea una nuova ricetta” troverai la bozza di ricetta che è stata creata sulla base della richiesta di ricetta che era nella sezione “Richieste”.
    ...
    ![Screenshot 2025-04-04 alle 14.14.35.png](/images/platform/richieste-ricetta/Screenshot_2025-04-04_alle_14.14.35.png)
    
- *Puoi decidere di elaborare la ricetta subito o più tardi*)
    
    ![Screenshot 2025-04-04 alle 14.14.58.png](/images/platform/richieste-ricetta/Screenshot_2025-04-04_alle_14.14.58.png)
...
- Tornando alla sezione “***Richieste***”: le richieste si possono **eliminare** cliccando i tre puntini a destra della richiesta e selezionando “Elimina”
    ...
    ![Screenshot 2025-04-04 alle 14.15.19.png](/images/platform/richieste-ricetta/Screenshot_2025-04-04_alle_14.15.19.png)
    
- Prima dell’eliminazione comparirà una schermata di conferma:

![image.png](/images/platform/richieste-ricetta/image%201.png)
...
- Altro
    ...
    ![Screenshot 2025-04-08 alle 09.33.13.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_09.33.13.png)
...
- Nella sezione “***Archivio***” (delle richieste) si possono visualizzare tutte le “***Richieste di ricetta***” che son state processate ed elaborate (sia tramite altri gestionali che da Elty).
    ...
    ![Screenshot 2025-04-08 alle 09.41.00.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_09.41.00.png)
...
- Nella sezione “***Da rinnovare***” si trovano tutte le richieste di rinnovo di prescrizioni continuative che sono state impostate nella scheda dei pazienti e che sono già state elaborate in passato all’interno di Elty. Cliccando “***Rinnova tutte***” si rinnoveranno tutte in automatico sulla base delle informazioni inserite della stessa prescrizione precedentemente prescritta.
    ...
    ![Screenshot 2025-04-08 alle 09.41.13.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_09.41.13.png)
...
- Quando si inserisce in Elty DaVinci una “***Nuova richiesta***” si può scegliere una “***Prestazione***” invece di “***Farmaco***”.
    ...
    ![Screenshot 2025-04-08 alle 09.41.48.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_09.41.48.png)
...
- Si può scegliere tra una “***Nuova prestazione***” e “***Rinnova prestazione***”. Si inserisce il nome della prestazione (*che potrà esser cliccata tra le prestazioni inserite nel database di **Elty DaVinci, aggiornate sulla base dei cataloghi regionali***). Si possono inserire anche “***Note interne***”.
    ...
    ![24..png](/images/platform/richieste-ricetta/24..png)
...
- Dopo aver inserito tutte le informazioni necessarie si può scegliere di aggiungere una nuova prestazione cliccando “***Aggiungi nuovo***” (o conferma e richiedi altro) o si conferma la prestazione inserita cliccando “***Conferma***”.
    ...
    ![25..png](/images/platform/richieste-ricetta/25..png)
...
- La richiesta di “***Prestazione***” potrà esser visualizzata nella sezione “***Richieste***” (da prescrivere o da rinnovare). Cliccando “***Prescrivi***” comparirà una nuova schermata.
    ...
    ![26..png](/images/platform/richieste-ricetta/26..png)
...
![Screenshot 2025-04-08 alle 09.55.24.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_09.55.24.png)
...
- La bozza può essere elaborata cliccando “Elabora” e può essere messa in coda cliccando “Elabora più tardi”
    ...
    ![Screenshot 2025-04-08 alle 09.57.33.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_09.57.33.png)
...
- Se si vuole permettere ai propri pazienti di mandare “***Richieste di ricetta***” **tramite App** si può attivare la funzione andando sul tuo nome e cognome in alto a destra e poi “***Gestione servizi***”.
    ...
    ![Screenshot 2025-04-08 alle 09.59.15.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_09.59.15.png)
    
- Per attivare le “***Richieste di ricette***” bisogna cliccare l’apposito tasto a destra di “***Personalizza***”.
    
    ![Screenshot 2025-04-08 alle 10.01.31.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_10.01.31.png)
...
- Si può decidere di abilitare alcune richieste e altre no (es. sì alle ripetitive di farmaci e no alle prestazioni ripetitive mentre sì per le richieste libere di prestazioni e no per le richieste libere di farmaci)
    ...
    ![Screenshot 2025-04-08 alle 10.04.10.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_10.04.10.png)
...
- All’interno della sezione “***Richieste***” verranno visualizzate le **richieste fatte tramite App** e le richieste inserite dal personale di segreteria (nella colonna “Richiesta” ci sarà la richiesta e anche “Richiesto da …”)
    ...
    ![Screenshot 2025-04-08 alle 10.40.57.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_10.40.57.png)
...
- Devo sempre inserire il quesito diagnostico a mano per ogni ricetta di prestazione che creo?
    ...
    No, quando seleziono “Prescrivi” e seleziono più prestazioni, in basso a sinistra della schermata in cui si crea la bozza di ricetta, dove ci sono le azioni globali, posso spuntare la dicitura “Voglio inserire un quesito diagnostico valido per tutte le prestazioni”
    
    ![Screenshot 2025-04-11 alle 12.10.48.png](/images/platform/richieste-ricetta/Screenshot_2025-04-11_alle_12.10.48.png)
...
- Per quale motivo alcuni farmaci vengono divisi su ricette diverse?
    
    Alcuni farmaci possono essere distinti in due gruppi diversi di ricette per i seguenti motivi:
    
    - **Tipologia di ricetta: bianca/rossa**
    - **Codice della ricetta**
    - **Piano Terapeutico**
    - **Esenzioni**
    - **Divisione ricette tra farmaci DPC e DD**
    - Per le prestazioni potrebbe dipendere dalla branca
    
    La distribuzione dei farmaci a carico del SSN avviene normalmente mediante la rete delle Farmacie aperte al pubblico (Farmacie pubbliche e private) convenzionate con il SSN (**Distribuzione convenzionata**).
    
    Una particolare modalità di distribuzione diretta si basa su un accordo che intercorre tra Regione/ASL/Distributori intermedi e Farmacie convenzionate (**DPC -** **Distribuzione Per Conto**): in tal caso i farmaci vengono acquistati dalla ASL/Regione ma distribuiti al paziente, per loro conto, dalle Farmacie territoriali aperte al pubblico.
...
- Posso inviare direttamente le ricette via mail al paziente?
    ...
    Si. Per poter abilitare questa funzionalità dovrete fare richiesta (basterà chiedercelo in un ticket o contattare uno dei membri del team di Elty). Una volta abilitata, troverete la funzionalità nella Gestione Servizi e potrete decidere di abilitarla e/o disabilitarla premendo su “Personalizza” e spuntando la voce “Abilita” (sezione Invio PDF delle ricette tramite e-mail)
    
    ![Screenshot 2025-04-11 alle 12.12.21.png](/images/platform/richieste-ricetta/Screenshot_2025-04-11_alle_12.12.21.png)
    
- Al paziente arriva una notifica quando ho processato una richiesta di ricetta?
    
    No, non arriva nessuna notifica (per facilitare quelle situazioni in cui i medici spuntano la ricetta ma non hanno ancora inviato la prescrizione al paziente) ma il paziente in app può vedere nella sezione **“Le tue ricette”** alla voce “Richieste” lo stato della richiesta. 
    
    - **In attesa**
    - **Completata**
    - **Annullata**
    
    Se la ricetta è stata validata dal sistema regionale ed è stata elaborata allora gli arriva:
    
    - L’email (se inserita nella scheda paziente ed è abilitato l’invio in gestione servizi)
    - Tramite codice NRE (se la Regione permette questo servizio)
    - Su FSE
        
        ![Untitled](/images/platform/richieste-ricetta/Untitled.png)
...
- Come si accede alle richieste di ricetta dei pazienti?
    ...
    Si può accedere alle **richieste** di ricetta cliccando **Richieste** in alto o **Richieste di ricetta** dalla **home**
    
    ![1..png](/images/platform/richieste-ricetta/1..png)
    
- Come navigare nella schermata delle richieste?
    
    La schermata presenta 3 sezioni:
    
    1. **Da prescrivere** raccoglie tutte le richieste **libere** dei pazienti;
    2. **Da rinnovare** raccoglie tutte le richieste da rinnovare
    3. **Archivio** raccoglie tutte le richieste evase 
        
        ![2..png](/images/platform/richieste-ricetta/2..png)
        
- Come inserire una richiesta manualmente?
    
    Per inserire manualmente una richiesta di ricetta bisogna cliccare **Nuova richiesta**
    
    ![3..png](/images/platform/richieste-ricetta/3..png)
    
- Come modificare una richiesta?
    
    La richiesta non può essere modificata ma può essere eliminata
    
- Come eliminare una richiesta?
    
    Cliccando i **tre puntini** a destra comparirà un menù a tendina con numerose funzioni. 
    Per eliminare la Richiesta cliccare sul pulsante **Elimina**
    
    ![Screenshot 2025-04-04 alle 14.15.19.png](/images/platform/richieste-ricetta/Screenshot_2025-04-04_alle_14.15.19.png)
    
    Eliminando la richiesta si può scegliere se mandare una comunicazione al paziente dell’avvenuta cancellazione
    
    ![Screenshot 2025-04-08 alle 09.33.13.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_09.33.13.png)
    
- A cosa servono e cosa sono le note interne?
    
    Le note interne sono uno strumento utile di comunicazione tra personale di segreteria e medico. Si possono usare per indicare informazioni aggiuntive sulla richiesta del paziente e in quanto interne non saranno visibili al paziente. 
    
    Per scrivere una nota interna cliccare i **tre puntini** a destra dove comparirà un menù a tendina con numerose funzioni, selezionare **Inserisci nota interna.** 
    
    Una volta scritta, può essere modificata cliccando **Modifica nota interna.**
    
    ![10..png](/images/platform/richieste-ricetta/10..png)
    
- Posso rispondere alla richiesta del paziente?
    
    Si, si può rispondere alla nota del paziente cliccando i **tre puntini** a destra dove comparirà un menù a tendina con numerose funzioni. “**Invia nota al paziente”** è la voce da selezionare per inviare una nota, che arriverà al paziente tramite notifica in App.
    
    La nota visualizzata in App dal paziente sarà nella sezione Notifica
    
    ![Untitled](/images/platform/richieste-ricetta/Untitled%201.png)
    
    ![Screenshot_20240411_094312_Elty (ex DaVinci).jpg](/images/platform/richieste-ricetta/Screenshot_20240411_094312_Elty_(ex_DaVinci).jpg)
    
- Come faccio a spostare in archivio le richieste?
    - Per spostare in archivio una richiesta si dovrà cliccare sul tasto a forma di “v”, la spunta.
    
    ![Schermata 2025-12-24 alle 11.20.59.png](/images/platform/richieste-ricetta/Schermata_2025-12-24_alle_11.20.59.png)
    ...
    - Cliccare il tasto “***Conferma***” per mandare la richiesta in archivio (non arriverà alcuna notifica al paziente se non ci sono note)
        ...
        ![Schermata 2025-12-24 alle 11.20.38.png](/images/platform/richieste-ricetta/Schermata_2025-12-24_alle_11.20.38.png)
        
- Come fa il paziente a inoltrare una richiesta?
    - *Dopo aver cliccato il nome del medico* clicca **Richiedi ricetta** ✅
        
        ![Untitled](/images/platform/richieste-ricetta/Untitled%202.png)
        
    - Se sono presenti farmaci e prestazioni continuative il paziente le ritroverà sotto le relative sezioni:
        
        ![1000000310.jpg](/images/platform/richieste-ricetta/1000000310.jpg)
    ...
    - Nel caso non ci fossero farmaci o prestazioni continuative procederà cliccando su **Richiedi una nuova ricetta** per una richiesta libera (se il medico l’ha abilitata).
        ...
        ![Untitled](/images/platform/richieste-ricetta/Untitled%203.png)
        
    - Il paziente potrà scegliere tra “**Farmaco”** e “**Visita o Esame”**
        
        ![Untitled](/images/platform/richieste-ricetta/Untitled%204.png)
    ...
    - C’è anche la possibilità di aggiungere un farmaco aggiuntivo cliccando sul tasto ***“Aggiungi altro farmaco”***
        ...
        ![IMG_0248 3.jpg](/images/platform/richieste-ricetta/IMG_0248_3.jpg)
    ...
    - Verrà aggiunta una sezione in cui inserire il ***nome del secondo farmaco*** ed e***ventuali note per il Medico.***  Cliccare, infine, su “***Continua***” per confermare la richiesta
        ...
        ![IMG_0249 3.jpg](/images/platform/richieste-ricetta/IMG_0249_3.jpg)
        
    - Dopo l’invio visualizzerà **Richiesta completata** e si potranno vedere i **Dettagli richiesta**
        
        ![Untitled](/images/platform/richieste-ricetta/Untitled%205.png)
        
    - Compariranno i dettagli richiesta. Si può eliminare la richiesta cliccando **Annulla richiesta**:
        
        ![Untitled](/images/platform/richieste-ricetta/Untitled%206.png)
...
- Come impostare il servizio di richieste ricette?
    ...
    Cliccare l’apposito tasto a destra di **Personalizza** 
    
    ![Screenshot 2025-04-08 alle 10.01.31.png](/images/platform/richieste-ricetta/Screenshot_2025-04-08_alle_10.01.31.png)
    
    Cliccando **Personalizza** si potranno scegliere le **Tipologie richieste** che si potranno fare da App. Le opzioni sono **Ripetitive (pre compilate)** e **Nuove richieste (libere)** entrambe attivabili per farmaci e prestazioni.
